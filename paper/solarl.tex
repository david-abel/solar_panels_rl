...
Additional relevant parameters were set as follows: $\gamma = 0.99$, time advances $3$ minutes per step in the MDP, and the panel is tilted $2\degree$ per action. All of our code for running experiments and for reproducing results is publicly available\footnote{{\it Redacted during review.}} %\url{https://github.com/david-abel/solar_panels_rl/experiments}}.
