...
\subfloat[Sample Sky Percepts\label{fig:sun_image}]{
	\includegraphics[scale=0.16]{figures/sun_img} \hspace{2mm}
	\includegraphics[scale=0.16]{figures/sun_img2}
} \hspace{16mm} % Sun image.
\subfloat[Sample Sky + Cloud Percepts\label{fig:sun_image_clouds}]{
	\includegraphics[scale=0.16]{figures/cloud_img} \hspace{2mm}
	\includegraphics[scale=0.16]{figures/cloud_img2}	
} % Clouds.
